...
import (
	...
	models "github.com/dnevsky/firstapi/models"
...
func (m *MockTodoList) Delete(userId, listId int) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Update(userId, listId int, input models.UpdateListInput) (int, error) {
	m.ctrl.T.Helper()
...
// Delete mocks base method.
func (m *MockTodoItem) Delete(userId, itemId int) (int, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, input models.UpdateItemInput) (int, error) {
	m.ctrl.T.Helper()
